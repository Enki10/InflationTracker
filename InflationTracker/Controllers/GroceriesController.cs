...
namespace InflationTracker.Controllers
{
    public class GroceriesController : Controller
    {
        private readonly InflationTrackerContext _context;

        public GroceriesController(InflationTrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,category,smname,groceryName,IssueDate,price")] Grocery grocery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,category,smname,groceryName,IssueDate,price")] Grocery grocery)
        {
            if (id != grocery.Id)
            {
                return NotFound();
